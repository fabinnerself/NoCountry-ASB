...
CREATE TYPE story_status AS ENUM ( 'ERROR', 'EXPORTADO','GENERADO','REGENERAdo','EDITAdo');
...
CREATE TABLE IF NOT EXISTS stories (
    ...
    user_input_text TEXT,                   -- Texto del usuario 
    ...
    version varchar(10) DEFAULT '1.0',      -- version cuando mismas variables y cuando cambie el texto generado
        
    -- ESTADO Y METADATA
    status story_status DEFAULT 'GENERADO',
    error_message TEXT,    
